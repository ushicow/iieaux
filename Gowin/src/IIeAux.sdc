...
//Created Time: 2026-03-28 23:02:10
...
create_generated_clock -name memory_clk -source [get_ports {mclk}] -master_clock mclk -divide_by 3 -multiply_by 9 [get_nets {memory_clk}]
create_generated_clock -name dma_clk -source [get_ports {mclk}] -master_clock mclk -divide_by 6 -multiply_by 9 [get_nets {dma_clk}]
