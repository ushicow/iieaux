...
//Created Time: 2026-04-06 21:02:41
...
create_generated_clock -name dma_clk -source [get_ports {mclk}] -master_clock mclk -divide_by 6 -multiply_by 8 [get_nets {dma_clk}]
